...
to initialize_turtles
  ...
  ask turtles [set lockdown? false]
   ...
   let potential_spreaders count turtles with [notp? = true] / 2 repeat (potential_spreaders)
 [
    ask one-of turtles with [notp? = true and spreader? = 0]
  [
    set spreader? true
  ]]
...
to infect
  ...
  if security_measures = false  [
  if student? = true [if any? other turtles in-radius 1.2 with [ sick? = false  ]  [ask other turtles in-radius 1.2 with [ sick? = false  ] [ if random 100 <= 69
    [ get-sick ] ]]]
  if worker? = true [if any? other turtles in-radius 1.1 with [ sick? = false  ]  [ask other turtles in-radius 1.1 with [ sick? = false  ] [ if random 100 <= 79.5
    [ get-sick ] ]]]
   if retired? = true [if any? other turtles in-radius 0.8 with [ sick? = false  ]  [ask other turtles in-radius 0.8 with [ sick? = false  ] [ if random 100 <= 100
      [ get-sick ] ]]]]

   if security_measures = true and spreader? = 0 [ if random 100 <= infectious_rate  [
  if student? = true [if any? other turtles in-radius 1.2 with [ sick? = false  ]  [ask other turtles in-radius 1.2 with [ sick? = false  ] [ if random 100 <= 69
    [ get-sick ] ]]]
  if worker? = true [if any? other turtles in-radius 1.1 with [ sick? = false  ]  [ask other turtles in-radius 1.1 with [ sick? = false  ] [ if random 100 <= 79.5
    [ get-sick ] ]]]
  ...
  if security_measures = true and spreader? = true [ if random 100 <= infectious_rate * 2 [ if student? = true [if any? other turtles in-radius 1.2 with [ sick? = false  ]  [ask other turtles in-radius 1.2 with [ sick? = false  ] [ if random 100 <= 69
    [ get-sick ] ]]]
  if worker? = true [if any? other turtles in-radius 1.1 with [ sick? = false  ]  [ask other turtles in-radius 1.1 with [ sick? = false  ] [ if random 100 <= 79.5
    [ get-sick ] ]]]
   if retired? = true [if any? other turtles in-radius 0.8 with [ sick? = false  ]  [ask other turtles in-radius 0.8 with [ sick? = false  ] [ if random 100 <= 100
...
to save
  export-all-plots "c:/Users/loren/Desktop/plot-csv"
end
@#$#@#$#@
GRAPHICS-WINDOW
335
