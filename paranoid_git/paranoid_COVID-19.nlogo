...
to discovery
 ...
 if discovery_type = "standard_max"
  [
  ifelse count turtles with-max [ranking] with [standard? = true or skeptic? = true ] = 0
   [maximize]
   [ask one-of turtles with-max [ranking] with [ standard? = true or skeptic? = true]
    [
     set color green
     set p? true
     set notp? false
  ...
  [
   ...
   [
    ...
    ask one-of turtles with [standard? = true or skeptic? = true]
    [
     set color green
     set p? true
     set notp? false
...
to setup_covid
  ...
  repeat misinformed [ ask one-of turtles with [notp? = 0] [set notp? true]]
  initialize_turtles
...
to go_covid
  ...
  lockdown
  ask turtles [if lockdown? = false and quarantine? = 0 [
    move]]
  ask turtles
  [
    if lockdown? = true and quarantine? = 0 [slow_move]
  ]
  break_quarantine
  ask turtles with [spreader? = true and quarantine? = 0] [ if lockdown? = true  [move]]
  ask turtles [if count turtles with [sick? = true ] >= 5 and sick-time > 5 and detection_sick_people = true [set quarantine? true]]
  ask turtles[
  if sick? = true and quarantine? = 0 [infect]
  sick-count
  recover-die
  ]
  time
  if count turtles with [ sick? = true ] = 0 [stop]
  tick
...
to break_quarantine
  ...
  if remainder ticks 20 = 0 [ask turtles with [notp? = true] [set spreader? false]]
  if deterrents = false [if remainder ticks 20 = 0 [ask turtles with [notp? = true and spreader? = false] [if random 100 <= 50 [set spreader? true]]]]
  if deterrents = true [if remainder ticks 20 = 0 [ask turtles with [notp? = true and spreader? = false] [if random 100 <= 10 [set spreader? true]]]]

end

to sick-count
 if remainder ticks 20 = 0 [if any? turtles with [sick? = true and contracted? = 0]
...
to lockdown
  ...
  [
  if lockdown_type = "lockdown_student" [ ask turtles with [student? = true] [ set lockdown? true]]
  if lockdown_type = "lockdown_worker"  [ ask turtles with [worker? = true] [set lockdown? true]]
  if lockdown_type = "lockdown_retired" [ ask turtles with [retired? = true] [set lockdown? true]]
  if lockdown_type = "lockdown_worker+retired" [ ask turtles with [worker? = true or retired? = true] [ set lockdown? true]]
  if lockdown_type = "lockdown_retired+student" [ ask turtles with [student? = true or retired? = true] [set lockdown? true]]
  if lockdown_type = "lockdown_student+worker" [ ask turtles with [student? = true or worker? = true] [set lockdown? true]]
  if lockdown_type = "essential_activities" [ ask turtles with [essential_worker? = 0] [set lockdown? true]]
  if lockdown_type = "all" [ ask turtles[ set lockdown? true]]
 ]
end
...
to time
  ...
  if ticks > 1 [if remainder ticks 20 = 0 [set days days + 1 ask turtles [sickness] ask turtles with [student? = true] [if lockdown? = true or quarantine? = true [ set neg_student neg_student + 0.75]]
  ask turtles with [worker? = true] [if lockdown? = true or quarantine? = true [ set neg_worker neg_worker + 1]]
  ask turtles with [retired? = true] [if lockdown? = true or quarantine? = true [ set neg_retired neg_retired + 0.5]] ]]
...
to infect
  ...
  if student? = true [if any? other turtles in-radius 1.2 with [ sick? = false  ]  [ask other turtles in-radius 1.2 with [ sick? = false  ] [ if random 100 <= 5
    [ get-sick ] ]]]
  if worker? = true [if any? other turtles in-radius 1.1 with [ sick? = false  ]  [ask other turtles in-radius 1.1 with [ sick? = false  ] [ if random 100 <= 6
    [ get-sick ] ]]]
   if retired? = true [if any? other turtles in-radius 0.8 with [ sick? = false  ]  [ask other turtles in-radius 0.8 with [ sick? = false  ] [ if random 100 <= 9
      [ get-sick ] ]]]]

  if security_measures = true and count turtles with [sick? = true ] >= 5 and notp? = 0  [
  if student? = true [if any? other turtles in-radius 1.2 with [ sick? = false  ]  [ask other turtles in-radius 1.2 with [ sick? = false  ] [ if random 100 <= 1.7
    [ get-sick ] ]]]
  if worker? = true [if any? other turtles in-radius 1.1 with [ sick? = false  ]  [ask other turtles in-radius 1.1 with [ sick? = false  ] [ if random 100 <= 2
    [ get-sick ] ]]]
   if retired? = true [if any? other turtles in-radius 0.8 with [ sick? = false  ]  [ask other turtles in-radius 0.8 with [ sick? = false  ] [ if random 100 <= 3
      [ get-sick ] ]]]]



   if count turtles with [sick? = true ] >= 5 and security_measures = true and notp? = true  [
  if student? = true [if any? other turtles in-radius 1.2 with [ sick? = false  ]  [ask other turtles in-radius 1.2 with [ sick? = false  ] [ if random 100 <= 3.4
    [ get-sick ] ]]]
  if worker? = true [if any? other turtles in-radius 1.1 with [ sick? = false  ]  [ask other turtles in-radius 1.1 with [ sick? = false  ] [ if random 100 <= 4
    [ get-sick ] ]]]
   if retired? = true [if any? other turtles in-radius 0.8 with [ sick? = false  ]  [ask other turtles in-radius 0.8 with [ sick? = false  ] [ if random 100 <= 6
      [ get-sick ] ]]]]
end
...
to recover-die
  ...
  if sick-time >= duration and retired? = false
  [set color grey set sick? 0 ]
  if sick-time >= duration and retired? = true and sick? = true
  [ifelse random 100 <= 7 [ set n_of_death n_of_death + 1 die] [set color grey set sick? 0 ] ]
...
to save
  ...
  [
    set-current-directory "c:/Users/loren/OneDrive/Desktop/experiments/Control_coronavirus/epidemic/epidemic_control_det(on)_sec(on)"
  ...
  [
    set-current-directory "c:/Users/loren/OneDrive/Desktop/experiments/Control_coronavirus/epidemic/epidemic_control_det(on)_sec(off)"
  ...
  [
    set-current-directory "c:/Users/loren/OneDrive/Desktop/experiments/Control_coronavirus/epidemic/epidemic_control_det(off)_sec(on)"
  ...
  [
    set-current-directory "c:/Users/loren/OneDrive/Desktop/experiments/Control_coronavirus/epidemic/epidemic_control_det(off)_sec(off)"
...
if count turtles with [notp? = true] > 0
  ...
  [
    set-current-directory "c:/Users/loren/OneDrive/Desktop/experiments/paranoid_coronavirus/epidemic/epidemic_paranoid_coronavirus_det(on)_sec(on)_pol(on)"
    export-world (word "control_epidemic_det(on)_sec(on)_pol(on)" random-float 1.0 ".csv")
  ]

     if detection_sick_people = true and security_measures = true  and deterrents = false

  [
    set-current-directory "c:/Users/loren/OneDrive/Desktop/experiments/paranoid_coronavirus/epidemic/epidemic_paranoid_coronavirus_det(on)_sec(on)_pol(off)"
    export-world (word "control_epidemic_det(on)_sec(on)_pol(off)" random-float 1.0 ".csv")
  ]

     if detection_sick_people = true and security_measures = false  and deterrents = false

  [
    set-current-directory "c:/Users/loren/OneDrive/Desktop/experiments/paranoid_coronavirus/epidemic/epidemic_paranoid_coronavirus_det(on)_sec(off)_pol(off)"
    export-world (word "control_epidemic_det(on)_sec(off)_pol(off)" random-float 1.0 ".csv")
  ]

     if detection_sick_people = false and security_measures = true  and deterrents = true

  [
    set-current-directory "c:/Users/loren/OneDrive/Desktop/experiments/paranoid_coronavirus/epidemic/epidemic_paranoid_coronavirus_det(off)_sec(on)_pol(on)"
    export-world (word "control_epidemic_det(off)_sec(on)_pol(on)" random-float 1.0 ".csv")
  ]

     if detection_sick_people = false and security_measures = false  and deterrents = true

  [
    set-current-directory "c:/Users/loren/OneDrive/Desktop/experiments/paranoid_coronavirus/epidemic/epidemic_paranoid_coronavirus_det(off)_sec(off)_pol(on)"
    export-world (word "control_epidemic_det(off)_sec(off)_pol(on)" random-float 1.0 ".csv")
  ]

     if detection_sick_people = false and security_measures = true  and deterrents = false

  [
    set-current-directory "c:/Users/loren/OneDrive/Desktop/experiments/paranoid_coronavirus/epidemic/epidemic_paranoid_coronavirus_det(off)_sec(on)_pol(off)"
    export-world (word "control_epidemic_det(off)_sec(on)_pol(off)" random-float 1.0 ".csv")
  ]

     if detection_sick_people = true and security_measures = false  and deterrents = true

  [
    set-current-directory "c:/Users/loren/OneDrive/Desktop/experiments/paranoid_coronavirus/epidemic/epidemic_paranoid_coronavirus_det(on)_sec(off)_pol(on)"
    export-world (word "control_epidemic_det(on)_sec(off)_pol(on)" random-float 1.0 ".csv")
  ]

     if detection_sick_people = false and security_measures = false  and deterrents = false

  [
    set-current-directory "c:/Users/loren/OneDrive/Desktop/experiments/paranoid_coronavirus/epidemic/epidemic_paranoid_coronavirus_det(off)_sec(off)_pol(off)"
    export-world (word "control_epidemic_det(off)_sec(off)_pol(off)" random-float 1.0 ".csv")
  ]
  ]
...
lockdown_type
lockdown_type
"lockdown_worker" "lockdown_retired" "lockdown_student" "none" "lockdown_worker+retired" "lockdown_retired+student" "lockdown_student+worker" "essential_activities" "all"
8
...
discovery</setup>
  ...
  <experiment name="control_det(on)_sec(off)" repetitions="30" runMetricsEveryStep="false">
  ...
  <experiment name="control_det(on)_sec(on)" repetitions="30" runMetricsEveryStep="false">
    <setup>setup_covid</setup>
    <go>go_covid</go>
    <metric>n_of_death</metric>
    <metric>days</metric>
  ...
  <experiment name="control_det(off)_sec(off)" repetitions="30" runMetricsEveryStep="false">
    <setup>setup_covid</setup>
    <go>go_covid</go>
    <metric>n_of_death</metric>
    <metric>days</metric>
  ...
  <experiment name="control_det(off)_sec(on)" repetitions="30" runMetricsEveryStep="false">
    <setup>setup_covid</setup>
    <go>go_covid</go>
    <metric>n_of_death</metric>
    <metric>days</metric>
  ...
  <experiment name="det(on)_sec(off)_pol(off)" repetitions="30" runMetricsEveryStep="false">
    <setup>setup
discovery
go_dis</setup>
    <go>go_covid</go>
  ...
  <experiment name="det(on)_sec(on)_pol(off)" repetitions="30" runMetricsEveryStep="false">
    <setup>setup
discovery
go_dis</setup>
    <go>go_covid</go>
  ...
  <experiment name="det(off)_sec(off)_pol(off)" repetitions="30" runMetricsEveryStep="false">
    <setup>setup
discovery
go_dis</setup>
    <go>go_covid</go>
  ...
  <experiment name="det(off)_sec(on)_pol(off)" repetitions="30" runMetricsEveryStep="false">
    <setup>setup
discovery
go_dis</setup>
    <go>go_covid</go>
  ...
  <experiment name="det(on)_sec(off)_pol(on)" repetitions="30" runMetricsEveryStep="false">
    <setup>setup
discovery
go_dis</setup>
    <go>go_covid</go>
  ...
  <experiment name="det(on)_sec(on)_pol(on)" repetitions="30" runMetricsEveryStep="false">
    <setup>setup
discovery
go_dis</setup>
    <go>go_covid</go>
  ...
  <experiment name="det(off)_sec(off)_pol(on)" repetitions="30" runMetricsEveryStep="false">
    <setup>setup
discovery
go_dis</setup>
    <go>go_covid</go>
  ...
  <experiment name="det(off)_sec(on)_pol(on)" repetitions="30" runMetricsEveryStep="false">
    <setup>setup
discovery
go_dis</setup>
    <go>go_covid</go>
